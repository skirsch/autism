# Prespecified Predictions — Verified SOA Survey Data (version 9 draft)

**Drafted:** 2026-08-30, after inspection of the first 270 survey responses.  
**Status:** Superseded by v10. V10 requires separate VAX and NEVER results tables without requiring a formal between-group interaction.  
...
## 3. Summary decision table and mutually exclusive scoring
...
- **Vaccine favored:** P7 is Vaccine and verification tiers agree in direction.
- **Null favored against a material short-window effect:** P7 is Null and no prespecified multiplicity-controlled product/window analysis finds a material association.
- **Indeterminate:** P7 is Indeterminate or verification tiers materially conflict.
...
Publish a seven-row results table and validate in code that every row is exactly `Null`, `Vaccine`, or `Indeterminate`.
