# Items That Must Be Obtained Outside This Bundle

These items cannot be completed accurately without the PI, reviewing institution, participating clinics, or IRB. Obtain and place copies in the final submission package when required.

## Required or commonly required

- The reviewing IRB’s completed online application or official cover form.
- Liz Mumper’s current CV or biosketch.
- CV/biosketch for other key personnel when required.
- Current human-subjects-protection training certificates for all study personnel.
...
- Letters of cooperation from participating clinics, if required.
- The reviewing IRB’s approval, exemption, or not-human-subjects determination letter after review.
