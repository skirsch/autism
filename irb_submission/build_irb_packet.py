...
numbered(doc,[
    'Aim 1: Test whether onset timing is distributed uniformly within the interval between adjacent vaccinations or is disproportionately concentrated near the preceding vaccination. Primary normalized measure: U = Dpre / (Dpre + Dpost). Under the primary null model, onset is uniformly distributed within each observed interval and U follows Uniform(0,1).',
    'Aim 2: Estimate and compare prespecified short-window concentrations, especially Dpre = 0–2 days and Dpre = 0–7 days, against their child-specific null expectations. These windows provide interpretable effect estimates without defining the study’s success by one arbitrary cutoff.',
    'Aim 3: Describe timing patterns by age at onset and sex, and assess robustness to same-day coding, interval length, alternative risk windows, and other sensitivity analyses supported by the five received variables.',
])
